      ...
      <div className="mb-8 h-full min-h-[500px] w-full sm:mt-32">        
        <div className="m-auto flex w-full max-w-screen-lg flex-col items-center justify-center px-5 sm:flex-row">
          ...
          <div className="flex flex-col justify-center sm:mr-10">
            <h2 className="text-edge-outline z-10 animate-title cursor-default whitespace-nowrap  text-center font-display text-4xl font-bold text-slate-800 duration-1000 dark:text-slate-200 sm:text-4xl md:text-5xl lg:text-6xl">
              {`Thien Nguyen`}
            </h2>
            {/* Description */}
