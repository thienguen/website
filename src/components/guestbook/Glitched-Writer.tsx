...
const GlitchedComponent: React.FC<GlitchedComponentProps> = ({ initialText = 'Welcome!' }) => {
  ...
  return (
    <div className="relative mx-auto flex h-12  max-w-2xl items-center justify-center overflow-hidden">
      <div
        ref={textRef}
        className="sm:balanced relative text-center font-dosis text-2xl font-semibold leading-6 text-lightPrimaryColor dark:text-slate-300 sm:text-left"
      >
